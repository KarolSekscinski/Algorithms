...
public class HashLinearProbingTest {
    ...
    public void shouldThrowExceptionWhenInitialSizeIsLowerThanOne() {
        ...
        // when
        HashTableForOpenAddressing<Double> unusedHash = new HashLinearProbingForOpenAddressing<>(initialSize);
    ...
    public void shouldCorrectlyAddNewElemsWhenNotExistInHashTable() {
        // given
        HashTableForOpenAddressing<String> emptyHash = new HashLinearProbingForOpenAddressing<>();
    ...
    public void shouldCorrectlyCountIdInHashBasedOnSizeOfHashAndAddedValue() {
        //given
        HashTableForOpenAddressing<Integer> hashTable = new HashLinearProbingForOpenAddressing<>(5);
        ...
        assertEquals(3, hashOfThirdElem);
    }
    ...
    public void shouldCorrectlyCountIdInHashBasedOnSizeOfHashAndAddedValueForExtremeIntegers() {
        ...
        assertEquals(3, hashOfSecondElem);
    }

    @Test
    public void shouldCorrectlyCountIdInHashBasedOnSizeOfHashAndAddedValueForExtremeDoubles() {
        //given
        HashTableForOpenAddressing<Double> hashTable = new HashLinearProbingForOpenAddressing<>(5);
        //when
    ...
    public void shouldCorrectlyPuttingDiffrentElemsWithTheSameHashCode() {
        ...
        assertEquals(2, hashOfSecondElem);
        assertEquals(3, hashOfThirdElem);
        assertEquals(4, hashOfFourthElem);
    }

    @Test
    public void shouldCorrectlyAddElemWhichIsntAlreadyInHashTable() {
        //given
        HashTableForOpenAddressing<String> hashTable = new HashLinearProbingForOpenAddressing<>();
        hashTable.put("a");
        hashTable.put("b");
        hashTable.put("c");
        //when
    ...
    public void shouldCorrectlyDeleteFirstElemAfterAddingAFewElemsToHashTableWhenEveryElemHasTheSameHashCode() {
        //given
        HashTableForOpenAddressing<Integer> hashTable = new HashLinearProbingForOpenAddressing<>();
        hashTable.put(1);
        hashTable.put(11);
        hashTable.put(21);
        int expectedSizeBefore = 3;
