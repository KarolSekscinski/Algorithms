...
public class QuickSortPerformanceTest {
    private Sorting quickSort = new QuickSort();

    private int sizeOfArray = 4000;

    @Test
    public void quickSortPerformanceTestForPessimisticData() {
        //given
    ...
    @Test
    public void quickSortPerformanceTestForOptimisticData() {
        //given
        double[] nums = new double[sizeOfArray];
        for (int i = 0; i < nums.length; i++) {
            nums[i] = i;
    ...
    @Test
    public void quickSortPerformanceTestForRandomData() {
        //given
        double[] nums = new double[sizeOfArray];
